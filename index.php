...
<body>
    <nav class="navbars">
        ...
        <div id="buttons-nav" class="nav-buttons">
            ...
            <div id="ingreso">
                <button id="access"><a href="./pages/login.php">Administrador</a></button>
            </div>
        </div>
        ...
        <div class="cont">
            ...
            <div class="course-g1">
                ...
                <div class="course-text1">
                    ...
                    <button class="btn btn-dark"><a href="pages/Form_academico.php">Inscríbete aquí</a></button>
                </div>
            </div>
            ...
            <div class="course-g2">
                <div class="course-text2">
                    ...
                    <button class="btn btn-dark"><a href="pages/Form_empresarial.php">Inscríbete aquí</a></button>
                </div>
            ...
            <div class="course-g3">
                ...
                <div class="course-text3">
                    ...
                    <button class="btn btn-dark"><a href="pages/Form_robotica.php">Inscríbete aquí</a></button>
                </div>
            </div>
        </div>
    </section>
