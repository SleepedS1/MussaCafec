...
<body>
    <nav class="navbars">
        ...
        <div id="buttons-nav" class="nav-buttons">
            ...
            <button><a href="./Form_academico.html">Registro</a></button>
            <div id="ingreso">
    ...
    <div id="formulario" class="form-container1" style="display: block;">
        ...
        <form class="formulario" method="POST" autocomplete="off" action="../php/Forms/Academico/Form_ac_ponente.php">
            ...
            <div class="form-content">
                <label for="archivo_pdf">Selecciona un archivo PDF y PowerPoint aquí:</label><br>
                <input type="file" id="archivo_pdf" name="archivo_pdf" accept=".pdf, .pptx">
                <br>
                <br>
                <label for="archivo_word">Selecciona un archivo Word aquí:</label><br>
                <input type="file" id="archivo_word" name="archivo_word" accept=".docx, .txt">
                <br>
            </div>
            <br>
        ...
        <form class="formulario" method="POST" autocomplete="off" action="../php/Forms/Academico/Form_ac_poster.php">
            ...
            <br><br>
                ...
                <div class="form-container">
                    <label for="archivo">Selecciona un archivo PDF y Power Point aqui:</label><br>
                    <input type="file" id="archivo" name="archivo" accept=".pdf, pptx">
                    <br>
                    <br>
                    <br>
                    <label for="archivo">Selecciona un archivo Word aqui:</label><br>
                    <input type="file" id="archivo" name="archivo" accept=".docx, .txt">
                    <br>
                </div>
                <br>
                <input type="submit" class="btn btn-outline-success" name="contact" value="Enviar">
