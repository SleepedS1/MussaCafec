...
<body>
    ...
    // Crear una instancia de PDO y conectar a la base de datos
        ...
        <section id="business-fair-section" class="hidden">
            ...
            <table>
                ...
                while ($row_empresarial = $consulta->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo '<td>';
                    echo '<a href="php/Update/empresarial.php?id=' . $row_empresarial['id'] . '"><button class="update-button">Actualizar</button></a>';
                    echo '</td>';
                    echo '<td>';
                    echo '<a href="php/Delete/empresarial.php?id=' . $row_empresarial['id'] . '&eliminar=1"><button class="delete-button">Eliminar</button class="delete.button"></a>';
                    echo '</td>';
                    echo '</tr>';
                }
                ?>
            ...
            <table>
                <tr>
                    ...
                    while ($row = $consulta->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo '<td>';
                        echo '<a href="php/Update/robotica.php?id=' . $row['id'] . '"><button class="update-button">Actualizar</button ></a>';
                        echo '</td>';
                        echo '<td>';
                        echo '<a href="php/Delete/robotica.php?id=' . $row['id'] . '&eliminar=1"><button class="delete-button">Eliminar</button ></a>';
                        echo '</td>';
                        echo '</tr>';
                    }
                    ?>
