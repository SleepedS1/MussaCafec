...
if (isset($_POST['contact'])) {
    ...
    if (
        ...
        $consulta = $pdo->prepare("INSERT INTO ac_ponentes (categoria, opciones, titulada, ficha, institucion, n_ponentes, titulo, email, proyecto, fecha) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

        // Ejecutar la consulta
        $resultado = $consulta->execute([$categoria, $opciones, $titulada, $ficha, $institucion, $n_ponentes, $titulo, $email, $proyecto, $fecha]);
